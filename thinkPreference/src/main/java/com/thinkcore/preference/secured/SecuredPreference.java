package com.thinkcore.preference.secured;
...
public class SecuredPreference implements SharedPreferences {
    ...
    private static SecuredPreference mInstance;
     ...
     */
    public SecuredPreference(@NonNull Context appContext, @Nullable String storeName, @Nullable String keyPrefix,
    ...
    public static void setRecoveryHandler(RecoveryHandler recoveryHandler) {
        SecuredPreference.mRecoveryHandler = recoveryHandler;
    }

    synchronized public static SecuredPreference getSharedInstance() {
        if (mInstance == null) {
    ...
    public static void init(Context appContext, @Nullable String storeName, @Nullable String keyPrefix, @Nullable byte[] bitShiftingKey,
        ...
        mInstance = new SecuredPreference(appContext, storeName, keyPrefix, bitShiftingKey);
    }
