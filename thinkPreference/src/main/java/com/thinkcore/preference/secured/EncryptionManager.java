...
@RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
 class EncryptionManager {
    ...
    SecuredPreference.KeyStoreRecoveryNotifier mRecoveryHandler;
     ...
     */
    public EncryptionManager(Context context, SharedPreferences prefStore, SecuredPreference.KeyStoreRecoveryNotifier recoveryNotifier)
    ...
    public EncryptionManager(Context context, SharedPreferences prefStore, @Nullable String keyAliasPrefix,
                             @Nullable byte[] bitShiftingKey, SecuredPreference.KeyStoreRecoveryNotifier recoveryHandler)
